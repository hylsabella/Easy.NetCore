...
{
    public static class DefendAttack_WebApi
    {
        /// <summary>
        /// 获取需要预防流量攻击的模块
        /// </summary>
        public static List<DefendAttackModel> GetLimitAttackModel(Assembly assembly)
        {
            ...
            {
                bool isSubClassOfController = typeof(Microsoft.AspNetCore.Mvc.ControllerBase).IsAssignableFrom(controllerType);
        ...
        private static List<DefendAttackModel> GetActionDefendAttr(Type controllerType)
        {
            ...
            {
                var routeAttribute = action.GetCustomAttribute<Microsoft.AspNetCore.Mvc.RouteAttribute>();
